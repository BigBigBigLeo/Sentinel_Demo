...
const DATA_SOURCES = [
    ...
    { id: 'weather_api', name: 'Weather Forecast API', nameZh: '天气预报API', type: 'realtime', icon: 'activity', color: '#60a5fa', channels: 8, freq: '15-min', format: 'JSON REST', volume: 96, unit: 'updates/day', latency: 850 },
...
function formatLatency(ms) {
    ...
    if (ms < 86400000) return `${(ms / 3600000).toFixed(0)}hr`;
